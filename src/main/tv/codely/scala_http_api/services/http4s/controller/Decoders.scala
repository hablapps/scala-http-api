package tv.codely.scala_http_api.services.http4s.controller
...
object Decoders{
  ...
  implicit def tupleVideoDecoder[P[_]](implicit 
    Ef: Effect[P]): EntityDecoder[P,(String, String, Duration, String, String)] =
